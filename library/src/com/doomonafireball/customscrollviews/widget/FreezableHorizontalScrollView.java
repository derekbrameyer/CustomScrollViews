 ...
 */
public class FreezableHorizontalScrollView extends HorizontalScrollView
    ...
    public FreezableHorizontalScrollView(Context context) {
        super(context);
    }

    public FreezableHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FreezableHorizontalScrollView(Context context, AttributeSet attrs, int defStyle) {
