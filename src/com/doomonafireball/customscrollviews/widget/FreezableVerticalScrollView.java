 ...
 */
public class FreezableVerticalScrollView extends ScrollView
    ...
    public FreezableVerticalScrollView(Context context) {
        super(context);
    }

    public FreezableVerticalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FreezableVerticalScrollView(Context context, AttributeSet attrs, int defStyle) {
