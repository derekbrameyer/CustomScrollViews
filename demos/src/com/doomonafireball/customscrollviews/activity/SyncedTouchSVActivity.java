...
public class SyncedTouchSVActivity extends RoboSherlockFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.synced_touch_scrollview);

        SyncedScrollManager ssm = new SyncedScrollManager(false, 1.0f);
        ssm.addTouchClient(leftSSV);
        ssm.addTouchClient(rightSSV);
